...
"<a href='http://e.weibo.com/yesmyloan' target='_blank'>新浪微博@国诚金融</a></p></div><div style='height: 0px; top: 0px;' class='sf_gotop'></div>"+
"</div>");
$(".footer_main").after('<div id="weixin_box"><a class="weixin_close" onclick="closeWeixin()" title="关闭二维码" href="javascript:void(0)"></a><img width title="扫一扫，关注国诚金融" src="/wdzj/images/front/h_weixin.jpg"></div>');

...
<div style="margin:0;padding:0;">
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "><strong>甲方（债权人）: &nbsp; </strong>国诚金融注册用户名： <span style="text-decoration:underline">${firstTransferVo.userName}</span></p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">(1)债务人（借款人）国诚金融网站注册用户名：<span style="text-decoration:underline">${firstTransferVo.userName}</span></p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">(5)借款年利率 ：<span style="text-decoration:underline">${firstTransferBorrowVo.borrowApr?string}%</span></p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方均需为国诚金融网站的注册用户；在遵守国诚金融网站上有关债权转让的各项规则的前提下，双方通过自行或授权其他方通过国诚金融网站进行债权转让。</p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、甲方欲转让债权需在国诚金融网站上提出书面申请，待国诚金融审核通过后方可进行转让。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、甲方应保证按照国诚金融网站债权转让规则中的相关规定按时足额缴纳债权转让费用。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方均认可并接受本协议约定的内容，且国诚金融网站审核通过甲方转让其债权时，本协议成立；待甲方收到乙方转让价款时本协议即时生效。</p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、本协议及其修改及补充协议均通过国诚金融网站以电子文本形式制成，可有一份或者多份并且每一份均具有同等法律效力。甲乙双方共同委托国诚金融在其专有服务器上保管本协议，并认可该形式电子合同的效力。</p>

...
<div style="margin:0;padding:0;">
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "><strong>甲方（转让人）: &nbsp; </strong>国诚金融注册用户名： <span style="text-decoration:underline">${transferUsername}</span></p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "><strong>乙方（受让人）: &nbsp; </strong>国诚金融注册用户名： <span style="text-decoration:underline">${subscribeUsername}</span></p>
    <p style="padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">鉴于甲乙双方均为上海国诚金融信息服务有限公司拥有的<span style="letter-spacing:0.1px;"> www.gcjr.com </span>网站（以下简称”国诚金融网站”）的注册用户，并已仔细阅读、充分理解并愿意遵守国诚金融网站上有关“投标直通车”服务计划下整体债权转让的各项规则，并将据此承担相应法律责任。现甲方欲通过国诚金融网站向乙方转让通过投标直通车功能购买的债权及剩余资金，经协商一致，甲乙双方达成以下协议，以资共同遵守。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方均需为国诚金融网站的注册用户；在遵守国诚金融网站上有关投标直通车服务计划转让的各项规则的前提下，双方通过自行或授权其他方通过国诚金融网站进行有关投标直通车服务计划下债权及剩余资金的整体转让。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">3、甲方欲转让本次服务计划需在国诚金融网站上提出申请，待国诚金融审核通过后方可进行转让，除非发生以下几种情况：</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">4、甲方欲转让债权，需按照国诚金融网站上的投标直通车服务计划转让规则支付转让费用，即购买时起3个月内转让的按直通车开通价格1%支付转让费用，3个月以后转让的按直通车开通价格的0.5%支付转让费用。当乙方支付合理对价时，系统扣除转让费用后将转让价款支付到甲方账户中。投标直通车服务计划转让成功时起，乙方成为该投标直通车服务计划下的服务用户，按照甲方原有顺位享有权利承担义务。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、甲方应保证按照国诚金融网站关于投标直通车服务计划转让规则中的相关规定按时足额缴纳转让费用。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "> 5、乙方自转让成功之日起成为投标直通车服务计划的用户，国诚金融的《“投标直通车”服务计划协议》开始对乙方生效。    </p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方均认可并接受本协议约定的内容，且国诚金融网站审核通过时，本协议成立并生效。</p>

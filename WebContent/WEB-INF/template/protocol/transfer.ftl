...
<div style="margin:0;padding:0;">
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "><strong>甲方（转让人）:</strong>国诚金融注册用户名： <span style="text-decoration:underline">${bTransferVo.userName}</span></p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; "><strong>乙方（受让人）:</strong>国诚金融注册用户名：</p>
    <table style="margin:0;padding:0;margin: 0px auto 20px;border-collapse: collapse;border: 1px solid #838383;width:90%;font-size: 12px;">
     <tr>
	 <td style="margin:0;padding:0;border: 1px solid #838383; text-align:left; padding:10px 4px;" width="50%">国诚金融注册用户（&lt;受让人名单&gt;详见附件一）</td>
    ...
    <p style="padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">鉴于甲乙双方均为上海国诚金融信息服务有限公司拥有的<span style="letter-spacing:0.1px;"> www.gcjr.com </span>网站（以下简称”国诚金融网站”）的注册用户，并已仔细阅读、充分理解并愿意遵守国诚金融网站上有关债权转让的各项规则，并将据此承担相应法律责任。现甲方欲通过国诚金融网站向乙方转让债权，经协商一致，甲乙双方达成以下债权转让协议，以资共同遵守。</p>
    ...
    <table style="margin:0;padding:0;margin: 0px auto 20px;border-collapse: collapse;border: 1px solid #838383;width:90%;font-size: 12px;">
      <tr>
	      <td style="margin:0;padding:0;border: 1px solid #838383; padding:10px 4px;" width="100px;" align="center">借款人国诚金融网站注册用户名</td>
      ...
      <tr>
	      <td style="margin:0;padding:0;border: 1px solid #838383; padding:10px 4px;" width="100px;" align="center">借款年利率</td>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方均需为国诚金融网站的注册用户。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">1、甲乙双方同意并确认，双方在遵守国诚金融网站上有关债权转让各项规则的前提下，在国诚金融网站上进行债权转让和受让方购买操作等方式确认签署本协议。</p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、甲乙双方接受本协议且国诚金融网站审核通过时，本协议立即成立。协议成立的同时乙方不可撤销地授权国诚金融自行或委托第三方支付机构将本协议约定的转让对价划转给甲方，甲方同意将其应缴纳给国诚金融的债权转让管理费由国诚金融自行或委托第三方支付机构直接在乙方支付的对价款中予以扣除。上述债权转让对价划转完成后即视为本协议生效且债权转让成功。</p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">3、债权转让完成后，国诚金融可根据实际情况将转让事项以电子邮件或站内信息的形式通知与标的债权对应的借款人。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、甲方应保证按照国诚金融网站债权转让规则中的相关规定向国诚金融按时足额支付债权转让管理费。</p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">2、本协议在履行过程中，如发生任何争执或纠纷，双方应友好协商解决；若协商不成，任何一方可向上海国诚金融信息服务有限公司住所地人民法院提起诉讼。 </p>
    ...
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">3、除本协议上下文另有定义外，本协议项下的用语及定义均与国诚金融网站有关规则中的定义相同。若有冲突，则以本协议为准。</p>
    <p style="margin:0;padding:0;padding:0px 10px 10px 0px; line-height:2em;overflow-x:hidden; ">4、本协议及其修改或补充均通过国诚金融网站以电子文本形式制成，可有一份或者多份并且每一份均具有同等法律效力。甲乙双方共同委托国诚金融在其专有服务器上保管本协议，并认可该形式电子合同的效力。</p>
	<p style="margin:0;padding:0;padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">附件一：受让人名单</p>
      ...
      <td style="margin:0;padding:0;border: 1px solid #838383; padding:10px 4px;" width="65px;" align="center">年化利率</td>	

...
<html>
<head>
  <title>${borrow.name}<c:if test="${borrow.pledgeType == 1}">(新增)</c:if><c:if test="${borrow.pledgeType == 2}">(续贷)</c:if><c:if test="${borrow.pledgeType == 3}">(资产处理)</c:if>_投标专区-国诚金融官网</title>
...
$(function (){
	   var  content= $.trim($("#tbinfo-borrowContentid").text())+"详情请登陆www.gcjr.com";

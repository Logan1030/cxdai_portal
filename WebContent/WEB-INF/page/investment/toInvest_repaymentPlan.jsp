...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table center tbtr02">
	...
	<tr>
		...
		<td >￥<fmt:formatNumber value="${repaymentRecord.repaymentAccount}" type="currency" pattern="#,##0.##"/> </td>
		<td >￥<fmt:formatNumber value="${repaymentRecord.capital}" type="currency" pattern="#,##0.##"/> </td>
		<td >￥<fmt:formatNumber value="${repaymentRecord.interest}" type="currency" pattern="#,##0.##"/> </td>
	</tr>
	</c:forEach>  
</table>

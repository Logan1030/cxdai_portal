...
<!--left-->
    <div class="leftwidth nomagrin">
      <div class="bg-blue fff">
        当前位置：<a style="color: #fff" href="${path}">国诚金融</a> &gt;<a style="color: #fff"  href="${path}/zixun.html">资讯中心</a> &gt; <a style="color: #fff" href="${path}/baike.html" >知识百科</a> &gt; ${cmsPediaEntry.name}
       </div>
       <div class="news1">
                <div class="pic">
                  <div class="mt10 pd4">

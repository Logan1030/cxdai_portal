         ...
         <div class="inner">      
               ...
               <div class="infors"  style="width: 200px">
		            ...
		            <shiro:notAuthenticated>          	
		     			<a   href="${path }/member/toRegister.html" rel="nofollow">注册</a>
			    ...
			    <${isHome!=null?'h1':'div style="top:28px"'} class="logo">
                   <a href="${path}"><img alt="囯诚金融" src="${basePath}/images/cms/logo.png" width="160" height="72"></a>
               </${isHome!=null?'h1':'div'}>
        <div class="userbar">
            <ul class="nav">
				<li><a href="${path}">国诚首页</a></li>
			  ...
			  --%>
                ...
                <li><a href="${bbsPath}" target="_blank">国诚社区</a><img class="mt-5" src="${basePath}/images/cms/hot.gif"/></li>
            </ul>

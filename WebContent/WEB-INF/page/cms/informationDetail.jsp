...
<!--left-->
    <div class="leftwidth nomagrin">
      <div class="bg-blue fff">
        当前位置：<a style="color: #fff"  href="${path}">国诚金融</a> > <a href="${path }/zixun.html" style="color:white;">资讯中心</a> > <a style="color: #fff"  href="${path }/${cmsArticle.urlCode }.html">${cmsArticle.channelName }</a> > ${cmsArticle.title }
       </div>
       <div class="news1">

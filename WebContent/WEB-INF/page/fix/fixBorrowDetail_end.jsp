...
<meta name="description"
	content="国诚金融是中国3A信用评级互联网理财借贷平台，如果你想了解更多P2P理财、网络投资理财或者资金周转借贷信息，详情请登陆www.gcjr.com。">
	...
	<div class="grid-1100">
    	<div class="product-deatil">
            ...
            <div class="detail-col-l fl item-bd-r">
            	<ul class="item-bd-b">
                	<li class="bdr percentbig"><span class="f14 gary line200">年化收益率</span><span class="oren precent"><fmt:formatNumber value="${fixBorrowVo.apr}" pattern="#,##0.##" /></span> <small class="f18 oren">%</small></li>
            	...
            	<ul class="item-bd-b" style="display:none">
                	<li><h6 class="f14">年化收益率 </h6><div class="percent"><span>10.0<small>%</small></span></div></li>
                ...
                <ul class="detailword">
                	<li style="padding-right:288px;"><h6>保障方式&nbsp;&nbsp;&nbsp;&nbsp;<span class="bule">100%本息保障</span></h6></li>
                </ul>
             </div>

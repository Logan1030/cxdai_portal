			...
			<div class="dec-body">
				<div class="copy-div">
			        <c:if test="${not empty  param.code}">
			         <input class="link-input"   id="txt-link-input"  data-s-chanid="1000" value="${basePath.concat('/member/toRegister.html?code=')}${param.code}" type="text">
			        </c:if>
			        ...
			        <a class="copy-btn btn">
			        	...
			        	<c:if test="${not empty  param.code}"> 
			        	    ${basePath.concat('/member/toRegister.html?code=')}${param.code} 
			        	</c:if>
				...
				<div class="qrbox-div">
			        ...
			        <c:if test="${not empty  param.code}">
			            <img src="${basePath}/lottery_chance/toEncoderQRCoder.html?url=${basePath.concat('/member/toRegister.html?code=')}${param.code}" width="150" height="150" />
			        </c:if>

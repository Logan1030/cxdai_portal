...
<body>
	<div class="contnew">
		<div class="main">
			<div class="btnbg2">
				<a href="${path}/member/toRegister.html" class="white-c"><button class="btn01" type="button" title="立即注册"></button></a>
			</div>
			<div>
			...
			<div class="btnbg">
				...
				<c:if test="${user==null }">
				  <a href="${path}/member/toLogin.html" class="white-c"><button class="btn02" type="button" title="请新去登陆"></button></a>
				</c:if>
			</div>
		</div>
	...
	<div><img src="${path}/images/ft-cj_02.jpg"/></div>
</body>

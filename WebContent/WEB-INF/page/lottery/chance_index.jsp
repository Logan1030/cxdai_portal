...
<div class="cont-body">
	<div class="cont-text">
    	<div class="text1">
            ...
            <div class="btn-red"><a href="${path }/member/toRegister.html">马上注册</a></div>
		</div>
        <div class="text2">
...
<div class="activity-notice">
	<div class="activity-word">
        ...
        <p>2. 更多推荐奖励规则请点击进入<a href="${path}/lottery_chance/toRecommendaward.html">推荐奖励专题页</a>查看。</p>
        <p>&nbsp;</p>
        <p>三、论坛签到奖</p>
        <p>论坛连续签到30天即可奖励1次抽奖机会 ，连续签到天数以论坛每天九点签到帖上的连续签到天数为依据。如果中间中断，重新从1开始计算。</p>
        <p>&nbsp;</p>
        <p>四、奖品及奖励发放规则</p>
        <p>1.凡抽中1888、iphone6的用户账户当前待收需为10万以上，否则视为无效；</p>
        <p>2.凡抽中其他现金奖项的，奖金立即发放，发放至个人账户，可前往“我的账户 > 有奖活动 > 我的奖励”中提取使用；</p>
        <p>3.所有奖项的有效期为30天，超过有效期未领取的，国诚金融有权收回奖励。</p>
        <p>&nbsp;</p>
        <p style="text-align:right">最终解释权归于国诚金融所有</p>
    </div>
</div>
...
function rotateResult(message, sourceTypeName, position, awardNum, awardType){
	...
	if(new Number(awardType) == 1){
		href = "${path}/lottery_use_record/lott_use_record.html?tabType=1";
	}
	if(new Number(awardType) == 2){
		href = "${path}/lottery_use_record/lott_use_record.html?tabType=2";
	}
	if(new Number(awardType) == 4 || awardType ==6 ){
		href = "${path}/lottery_use_record/lott_use_record.html?tabType=3";
	}
...
function recommendNow(){
	...
	if(userName != null && userName != ''){
		window.open("${path}/lottery_chance/toRecommendaward.html","_self");
	}else{
		layer.alert('您当前未登录，请先登录！',5,
				function(index) {
			window.open("${path}/member/toLogin.html?backUrl=1","_self");
        });
	}
}

		 ...
		 <table width="875" border="1">
			...
			<c:forEach items="${firstTenderRealPage.result}" var="firstTenderReal" varStatus="sta">
		        <tr>
		          ...
		          <td>
		           	<a href="${path}/newcxdai/first/tender/detail/queryFirstTenderDetail/10.html?firstBorrowId=${firstTenderReal.firstBorrowId}" target="_parent">查看明细</a>
		           	<a href="${path}/newcxdai/account/borrowManager/collectionFirst_record/10.html?firstBorrowId=${firstTenderReal.firstBorrowId}" target="_parent">查看投标</a>

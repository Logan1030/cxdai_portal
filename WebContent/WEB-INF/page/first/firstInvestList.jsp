...
<html>
<head>
    <title>理财直通车_p2p网贷理财平台_直通车专区-国诚金融官网</title>
	<meta name="keywords" content="P2P网络投资理财, P2P网贷理财,直通车专区" />
	<meta name="description" content="投标直通车是国诚金融推出的一种投标功能，目的是简化出借者的投标流程，提高资金使用率，为投资人提供快捷、有效、安全、的理财。如果你想了解国诚金融理财直通车或者P2P网贷理财平台，详情请登陆www.gcjr.com。">
...
<!--内容开始-->
<div id="Bmain">
	<div class="title"><span class="home"><a href="${path}/">国诚金融</a></span><span><a href="javascript:void(0);">我要投资</a></span><span><a href="${path}/zhitongche.html"> 直通车专区</a></span>

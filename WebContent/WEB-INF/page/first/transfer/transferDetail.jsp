            ...
            <em>认购转让的直通车后，资金需至少锁定6个月</em>
             ...
             <c:if test="${firstTransfer.status==2}">
                <div class="detail-join-m">
                    <div class="clearfix pdt10"><a href="${path}/account/topup/toTopupIndex.html" target="_blank" class="fr bd">充值</a>
                    <span class="f14">账户余额<c:choose>
									...
									<c:otherwise>
										<a href="${path}/member/toLogin.html?backUrl=1" >登录后查看</a>
 
									</c:otherwise>
								</c:choose> </span></div>
                                <div class="clearfix pdt10"><span class="f14">当前可投<strong class="oren f18 pdla"><c:choose>
	...
	<div class="cont-word">
        ...
        <div class="form-info-layer">
        	...
        	<div class="form-col2">
                ...
                <input type="password" name="payPassword" id="payPassword"  style="width:120px" class="colright form-inpyt-sm"  placeholder="输入交易密码"><a href="${path}/AccountSafetyCentre/safetyCentre/enterFindTransactionPwd.html" target="_blank" class="fl pdlr10 line32">忘记密码</a>
            </div>
            <c:if test="${null!=firstTransfer.bidPassword && firstTransfer.bidPassword!= ''}">
            <div class="form-col2">
                <label for="" class="colleft form-lable">认购密码</label>
                <input type="password" name="bidPassword" style="width:120px" class="colright form-inpyt-sm"  placeholder="请输入认购密码">
            </div>
            </c:if>
            <div class="form-col2">

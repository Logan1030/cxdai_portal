...
<div id="Bmain">
  <div class="title">
    <span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path }/myaccount/toIndex.html">我的账户</a></span><span>直通车转让</span><span><a href="${path}/zhitongche/zhuanrang/tocontainer.html">直通车转出</a></span>
  </div>
		<div id="menu_centert">
				<div id="menu_left">

				...
				<dl>
					<dd style="width: 650px;">
						...
						<c:if test="${currentBankCardVo != null and currentBankCardVo.status == 1}">
							...
							<div class="grid1 fl bd-line textcenter pink" style="line-height: 25px;">您的银行卡正在审核，请耐心等待！客服会在两个工作日内处理或联系。客服热线400-015-6676</div>
						</c:if>
						<%-- 银行卡被冻结 --%>
						<c:if test="${currentBankCardVo != null and currentBankCardVo.status == 2}">
							...
							<div class="grid1 fl bd-line textcenter pink" style="line-height: 25px;">您的银行卡未通过审核，请7天后重新申请或联系客服热线400-015-6676</div>
						</c:if>
					</dd>
					<dd style="color: red;">
						<span>可提金额：</span>

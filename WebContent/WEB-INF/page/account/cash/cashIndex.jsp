...
<div id="Bmain">
    <div class="title">
    	<span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path}/myaccount/toIndex.html">我的账户</a></span><span><a href="#">资金管理</a></span><span><a href="${path }/myaccount/cashRecord/toCashIndex.html">提现</a></span>
  	</div>
	<!--我的账户左侧 开始 -->    

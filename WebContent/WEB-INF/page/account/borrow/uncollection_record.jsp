...
<div class="gonggao" style="margin-bottom:10px;margin-top:-5px;"><span> 没时间亲自投标？开启自动投标后，国诚金融帮您轻松理财</span><a href="${path}/myaccount/autoInvest/autoInvestMain.html" class="btn-gg">自动投标</a></div>
	...
	<div class="myid whitebg">
		<table border="0">
			...
			<c:forEach items="${CollectionRecordList}" var="collectionRecord"
				...
				<td width="88" class="numcolor">${collectionRecord.interestStr}
					元</td>

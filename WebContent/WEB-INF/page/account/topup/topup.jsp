...
<form action="" name="topupform" id="topupform" method="post" target="_blank">
   ...
   <hr class="hr clear" />
     <div class="tip">
         <h3>温馨提示：</h3>
            <p>1、理财用户使用网银在线、连连支付、富友支付线上充值免费，所需要的费用，由国诚金融承担； </p>
            <p>2、充值完成后，请耐心等待页面跳转回到国诚金融网站，请不要直接关闭窗口，如果充值金额没有到帐，请和我们的客服联系；  </p>
            <p>3、国诚金融禁止信用卡套现、虚假交易等行为,一经发现将予以处罚,包括但不限于：限制收款、冻结账户、永久；</p>
...
function toAlipayFun(){
	var content = '<div class="val_tips red">说明：支付宝充值账号 44461248@qq.com，用户名：王建章；充值成功后提交申请，如未到账请联系客服人员！</div>';

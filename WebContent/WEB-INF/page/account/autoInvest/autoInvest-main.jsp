...
<div id="Bmain">
    <div class="title">
    	<span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path}/myaccount/toIndex.html">我的账户</a></span><span><a href="#">投资管理</a></span><span><a href="${path }/myaccount/autoInvest/autoInvestMain.html">自动投资</a></span>
  	</div>
	<!--自动投标左侧 开始 -->    

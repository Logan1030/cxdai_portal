...
<%@ include file="/WEB-INF/page/common/taglib.jsp"%>
 <div id="menu_left">
    <ul id="menuul">
        ...
        <li onclick="showHideLeftItems(this);"><a href="javascript:;"><span class="icon icon3"></span>债权转让</a>
           <ul style="display:none">
              ...
              <li id="menu8-3"><a href="${path}/zhitongche/zhuanrang.html">直通车转入</a></li>
   ...
   <div ><a href="${path}/lottery_chance/toRecommendaward.html" title="推荐有奖"><img style="margin-top:15px;" src="${path}/images/smallbannerleft.jpg"/></a></div>
</div>

...
<div id="Bmain">
	<div class="login_tit loginbg">找回交易密码</div>
	<div class="login_main loginbg">
		<div class="login_mainbox ">
			<dl>
				...
				<dd></dd>
				<dd>
					<input type="button" class="login_btn" id="formSubmitbtn" value="提交" onclick="formSubmit()" style="cursor: pointer;"/>
				</dd>
				<dd></dd>
				<dd></dd>
				<dd>
		...
		$("#findPwdForm").ajaxSubmit({
			...
			success : function(result) {
				...
				if (result.code == '0') {
					...
					window.location='${path}/account/safe/findPwdResult.html?pwdType=pay&findType='+result.message;
				}
			},

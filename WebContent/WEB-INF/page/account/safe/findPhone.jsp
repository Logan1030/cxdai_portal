	  			...
	  			success : function(result) {
	  				...
	  				if (result.code == '0') {
	  					...
	  					layer.msg('验证通过，已发送重置密码至您的手机，请用重置密码登录后再修改登录密码',3,1,function(){
	  						window.open("${basePath}/member/toLogin.html","_self");//跳转到登陆页面
	  						});
	  				}
	  			},
...
<div id="Bmain"  class="phone">
       ...
       <span class="zh1" style="">手机找回密码</span>
       <span class="zh2" style=" "><a  onclick="findEmail();" style="cursor: pointer;">邮箱找回  <img src="${basePath}/images/gd.png"/></a></span>
         ...
         <div style=" text-align:center; "> <img src="${basePath}/images/tip.png" width="16" height="16"/>&nbsp;若以上方法仍无法找回密码，请联系客服400-0156-676</div>
           ...
           <!-- 第二步 -->
            ...
            <div style=" text-align:center; "> <img src="${basePath}/images/tip.png" width="16" height="16"/>&nbsp;若以上方法仍无法找回密码，请联系客服400-015-6676</div>
     ...
     <div id="Bmain" class="email" >
       ...
       <span class="yxzh1" style="">邮箱找回密码</span><span style="float:right; font-size:16px; padding-right:15px; padding-top:10px; "><a  onclick="findPhone();"  style="cursor: pointer; ">手机找回 <img src="${basePath}/images/gd.png"/></a></span></div>
       <form id="emailForm">
            <!-- 第一步 -->

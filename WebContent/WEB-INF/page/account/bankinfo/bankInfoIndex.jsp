...
<%@ include file="/WEB-INF/page/common/header.jsp"%>
	<div id="Bmain">
		<div class="title">
			<span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path }/myaccount/toIndex.html">我的账户</a></span><span><a
		...
		<div class="lb_waikuang border whitebg p-r">
			...
			<div class="bank">
				...
				<c:if test="${bc.status==1 }">
		 			<div class="tip pink">
						<h3>温馨提示：</h3>
						<p>您的银行卡正在审核，请耐心等待！客服会在两个工作日内处理或联系。客服热线400-015-6676</p>
					</div>
				</c:if>
				<c:if test="${bc.status==2 }">
		 			<div class="tip pink">
						<h3>温馨提示：</h3>
						<p>您的银行卡未通过审核，请7天后重新申请或联系客服热线400-015-6676</p>
					</div>
				</c:if>
			</div>

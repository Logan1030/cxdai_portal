...
<form id="fm" name="fm" method="post" >
	...
	<div id="Bmain">
		<div class="title">
			<span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path }/myaccount/toIndex.html">我的账户</a></span><span><a href="#">账户管理</a></span><span><a href="${path }/bankinfo/toBankCard.html">银行卡信息</a></span>
		  </div>
		...
		<div class="lb_waikuang border whitebg">
               ...
               <dl>
                    ...
                    <dd>
                     ...
                     <dd>
								...
								<input type="text" id="phone" name="phone" style="width: 200px" dataType="Require" msg="手机号不能为空" maxlength="15"/>
							</dd>
							<dd>
          ...
          <div class="tip">
             <div class="safebox550">
						<h3>温馨提示：</h3>
						<p>1.更换卡的次数不能超过10次</p>
						<p>2.更换卡需等待客服审核，1-2工作日内处理或联系客服热线：400-015-6676</p>

...
<!-- 显示用户详情表单 -->
<form action="${basePath}/newcxdai/accountdetail/show.html"  id="showMemberInfoFrom" target="_blank" method="post">
...
function headuploadFunction(){
	window.location.href = "${path}/newcxdai/approve/headupload.html";
}
/**
 * 进入手机认证页面
 */
 ...
 */
function upFunction(){
	window.location.href = "${path}/newcxdai/approve/uploaddoc.html";
}

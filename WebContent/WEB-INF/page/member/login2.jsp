...
<div id="head_outer">   
<div id="outer_header">
      <div class="logo"><a href="${path}/<%=BusinessConstants.TOP_HOME_ADDRESS%>" title="国诚金融-用心呵护您的财富，分享成长的快乐！"><img src="${basePath}/images/logo.png" width="212" height="83" border="0" /></a></div>
      <div class="topmenulist">
          <div class="dl"><a href="${path }/home/regist.html"> 注册</a>
          <div class="photo1" > 财富热线：400-015-6676</div></div>           
      </div>
  </div>
</div><!--head off-->
	...
	if(username==""||username==null){
		...
		$.ajax({
			...
			success : function(data){
				$(obj).attr("onclick","submitLogin(this)");
				if(data=="success"){
					//window.open("${path}/newcxdai/myaccount/myAccountIndexForinsert.html","_self");//新版系统我的账户

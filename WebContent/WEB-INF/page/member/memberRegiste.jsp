...
<div id="header">
  <div class="inner">
    <div class="logo"> <a href="#"><img alt="囯诚金融" src="${basePath}/images/logo.png" width="160" height="72"></a> </div>
    <div class="tel">全国免费咨询热线:<span color="#1ca9dc">400-015-6676</span></div>
    <div class="jrgc"><a href="${basePath }">进入国诚金融</a></div>
  </div>
</div>
<!--head off-->
    ...
    <div class="loding-content" name="tc-a">
      ...
      <ul class="loding-windows">
        ...
        <li style="padding:10px 0;">
          ...
          <span class="ck-text" style="cursor:pointer;" onclick="toBorrowXiyi();">我已阅读并同意《国诚金融条款》</span> </li>
        <li>
  ...
  <div class="content-top bigboxwk" >
    ...
    <ul class="top-dl">
      ...
      <li class="text-nr">
        ...
        <p>脱胎于老牌资产管理公司上海国阳资产</p>
        <p style=" ">经营最稳健的房产抵押，且只做上海地产</p>
      </li>
    </ul>
  </div>
  <!---------------------------三块内容——结束----------------------------------------> 
...
/*		//
  ...
  <div class="bigboxwk">
    ...
    <ul class="new-th">
      <li class="ct-l"> <a href="http://www.gcjr.com/lottery_chance/info.html
...
<div style="width:100%; ">
    ...
    <div class="bigboxwk tishi-bottom" >
      <p style=" *line-height:30px;">*温馨提示：因国诚金融在业内的信誉，透明，风险控制方面形成的口碑，近期被大量其他平台进行推广冒用。<br/>搜索“国诚金融”时，请认准www.gcjr.com为国诚唯一官网网址</p>
<!--      <p style=" *line-height:15px;"></p>-->
    </div>
    <ul class="bottom-text" style="padding-bottom:15%;  *width:100%;" >
      <li style="margin-left:80px !important;">
        <p style=" *line-height:25px;">社科院、新华网联合评估权威认证<br/>国诚金融被评选为“中国网贷A级企业”</p>
    <!--    <p  style=" *line-height:10px;margin-top:0px\9;"></p>-->
      </li>
      <li style="margin-left:110px;">
        <p style=" *line-height:25px; ">国诚金融被评为<br/>“年度P2P平台最佳潜力奖”</p>
      <!--  <p style=" *line-height:10px;margin-top:0px\9; "></p>-->
      </li>

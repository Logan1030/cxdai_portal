...
<div class="pcregisterd" style=" border:none;" >
    <div class="titlewinows  titlewinows1" style="width:100%;" >
        ...
        <div class="pc-r pc-r1" style="">已有账号<a href="${basePath}/member/toLogin.html">立即登录</a></div>
    </div>   
    <!----------注册内容--------------------> 
		...
		$("#register_form").ajaxSubmit({
			...
			success : function(result) {
				...
				if(result.code=="1"){
					...
					var username = $.trim($('#username').val());
					var url="${path}/user/userSuccess.html?username="+username;

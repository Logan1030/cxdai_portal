 ...
 <div class="sf" >
         <div class="safebox550">
                   <dl>
                      ...
                      <dd><span>债权价格：</span><%-- ${transfer.capital}+${transfer.interest}-${transfer.gainLoss}= --%><label id="account">${transfer.account}</label>元</dd>
                      <dd><span><font color="#22adce">*</font>转让系数：</span><input  type="text" style="width:150px"  id="coef" name="coef"  maxlength="5"  value="1.000"  onblur="changeAccountReal()"   >
                      系数在0.99~1.00之间</dd>
                      <dd><span>转让价格：</span><label id="accountReal" >${transfer.accountReal}</label>元</dd>
                      <dd><span>转让管理费：</span><label id="manageFee" >${transfer.manageFee}</label>元 （转让成功后扣除）</dd>        
                     <dd style="width: 550px;"  ><span><font color="#22adce">*</font>最大认购金额：</span><input type="text"  name="mostAccount"  id="mostAccount" value="${transfer.accountReal}"  style="width:150px">元（不低于50，不超过转让价格） 
                      </dd>
                      <dd><span><font color="#22adce">*</font>最小认购金额：</span><input type="text"  name="lowestAccount" id="lowestAccount"  value="50" style="width:150px">元（不低于50）</dd>
                      <dd><span><font color="#22adce">*</font>失效时间：</span><div id="divValidTime"><input type="text" id="validTime"  maxlength="1"   name="validTime" value="3" style="width:150px">天</div>
                      <div id="divValidMinute" style="display:none;">1天（仅限定向转让）<input type="hidden" id="validMinute" name="validMinute"></div></dd>
                      <dd><span>定向密码：</span><input type="password" maxlength="12"   id="bidPassword"  name="bidPassword" style="width:150px;margin-top: 10px;" onblur="changeValidTh()">(可填可不填)</dd>
		     ...
		     <div class="gg_btn"><input type="button" value="确认"   onclick="doTransfer(${transfer.tenderId},${transfer.borrowId})"></div>            
		 </div>
       <div class="tip">
            <div class="safebox550">                             
                      <h3>温馨提示：</h3>                      

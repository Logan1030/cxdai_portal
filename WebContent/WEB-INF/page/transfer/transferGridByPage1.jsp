...
<body>
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table center">
                  <tr class="tbl-title">
                    <td class="tdpdtitle30" width="15%">借款标题</td>
                    <td class="textr" width="12%">转出价格</td>
                    <td class="textr" width="10%">年利率</td>
                  ...
                  <tr>
                    <td style="vertical-align:middle; text-align:left;" class="tdtitl07 bule"><span  class="icon ${cls} pdr"> </span>
                    <c:if test="${null!=transfer.bidPassword && transfer.bidPassword!= ''}"><font color="#EE30A7">[密]</font></c:if> 
				    <a href="javascript:;" style="color:#333;" onclick="toTransfer(${transfer.id});">
                    ...
                    <td class="textr"><fmt:formatNumber value="${transfer.borrowApr}" pattern="#,##0.##"/>%</td>
                    <td class="textr">

...
<title>我的账户_投标管理_债权转让_国诚金融</title>
...
<div id="Bmain">
  <div class="title">
    <span class="home"><a href="${path}/">国诚金融</a></span><span><a href="${path }/myaccount/toIndex.html">我的账户</a></span><span><a href="#">投标管理</a></span><span><a href="javascript:;">债权转让</a></span>
  </div>
		<div id="menu_centert">
				<div id="menu_left">

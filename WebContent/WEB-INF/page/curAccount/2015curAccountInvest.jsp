...
<meta charset="utf-8">
<title>活期宝_p2p网贷理财平台_活期宝-国诚金融官网</title>
</head>
		...
		<form action="" method="post" id="currentForm">
				...
				<div class="current-t mdt15">
					<table>
						...
						<tr>
							...
							<td colspan="2" class="green-c pl115"><strong>保障方式</strong>：<img src="${basePath}/images/safe-bao.png"/><strong>100%本息保障</strong></td>
						</tr>
					</table>
				</div>
			</div>
			<div class="fr currents tbzdbg pd10 h252 zhye-div"> 
				...
				<c:choose>
					...
					<c:otherwise>
						<a class="f16 blues-c" href="${path}/member/toLogin.html">登录后可见</a>&nbsp;&nbsp;
					</c:otherwise>
				</c:choose>

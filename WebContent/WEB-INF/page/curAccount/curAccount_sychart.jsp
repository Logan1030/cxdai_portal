...
<div class="searchbox fl whitebg">
	...
	<ul class="lb_title whitebg" style=" border-top:none;">
		...
		<li class="ml30 mdt10"><a class="textcenter pd-but mr5 red" href="javascript:void(0);" onclick="searchBtnSymx(7)">近7天</a></li>
		<li class="mdt10"><a class="textcenter pd-but" href="javascript:void(0);" onclick="searchBtnSymx(30)">近30天</a></li>
	</ul>
	<!-- 收益明细列表-查询条件 e -->
</div>

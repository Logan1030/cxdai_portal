...
<div class="product-wrap wrapperbanner"><!--banner star-->
	<div class="grid-1100">
        <div class="tz-detail">
            <img src="${path}/images/v5/detalibanner.png"/>
            <ul class="col4">
        ...
        <div class="product-deatil">
            ...
            <div class="tz-hqb clearfix" style="  position:relative;    ">
                <ul class="col3">
                    <li style="width:66%; ">
		                <div class="bar-boxd" >
		                <div class="bdr bdr-new "   > <span class="f14 gary " >预期年化收益率</span> <span class="oren pdl54  "  >5.6 <small class="f18 oren pdl20">%</small> </div>
		                <div class="bdr "   >
                    ...
                    <li>
                    	...
                    	<div class="tz-join-m" style="border-left:1px dashed #ccc; ">
                            ...
                            <div class="clearfix pdt10">
                            	...
                            	<input name="tenderMoney" id="tenderMoney" onblur="changeTenderMoney()" maxlength="20" class="form-inpyt-sm yuan" style="width:200px" type="text"  placeholder="请输入加入金额"/> 
                            </div>
                            <div class="clearfix pdt10">
                            	<input name="payPassword" id="payPassword" autocomplete="off" maxlength="30" class="form-inpyt-sm" style="width:106px" type="password" placeholder="输入交易密码"/>
                            	<input name="checkCode" id="checkCode" maxlength="4" class="form-inpyt-sm marginl10" style="width:106px" type="text" placeholder="请输入验证码"/>
                        ...
                        <div class="detail-join-m" style="  margin-left:30px">
	                    	<div class="clearfix pdt10 pd20" style="padding-top:50px;"><span class="f14 gary2"><span>账户余额</span><a href="${path}/member/toLogin.html?backUrl=1" class="pdla login" style="color: hsl(203, 88%, 58%); padding:0 10px;">登录</a><span>后可见</span></span> </div>
		                    	<div class="clearfix pdt38" style="padding-top:62px; ">
			                        <div class="btn-box2" style="width:315px;">
			                           	<button type="button" class="btn btn-join f16" onclick="window.location='${path}/member/toLogin.html?backUrl=1';">立即加入</button>
			                        </div>
		                     	</div>
	                		</div>
                		</c:if>
...
<div class="product-wrap"><!--定期宝star-->
	<div class="grid-1100 tz-hqb-bg" style="margin-top:60px">
        ...
        <div class="hqb-word02">
        	<h2>高收益，理财功能更多样</h2>
            <p>年化收益5.6%，是余额宝的1.4倍，活期存款的16倍</p>
            <p>随时用活期宝资金申购国诚金融其它理财产品，享受15%以上的超高收益</p>
            <p>从此资金不再站岗，万元投资，单月收益47元</p>
        </div>
        <div class="hqb-word03">
        	<h2>资金安全有保障</h2>
            <p>低风险的货币基金理财产品（申购银行理财计划）</p>
            <p>活期宝资金享受100%的本息保障</p>
        </div>
     </div>
     <div class="grid-1100">
            ...
            <div class="menucont" style="clear:both">
            	<div class="tbl-cont">
                    ...
                    <div class="hqb-js">
                        ...
                        <div class="fl word">活期宝是国诚金融推出的一款货币基金理财产品（申购招商银行理财计划），帮助投资人将加入的资金享受稳定收益，每天都可赎回的投资计划。投资人加入的资金及加入资金所产生的收益，在计息后可申请部分或全部赎回。</div>
                    </div>
                    <div class="hqb-js clearfix">
                    	<div class="fl title">年化收益</div>
...
function joinFunction(){
	...
	if(layer.confirm("你确认把"+$("#tenderMoney").val()+"元加入到活期宝吗？",function(){
		saveCurrent();
	}));
}
/**
   ...
   $("#currentForm").ajaxSubmit({
	   ...
	   success:function (data){
			...
			if (data.code == '99' || data.code == '-6') {
				...
				layer.close(_load);
				layer.alert("此次交易成功转入"+$("#tenderMoney").val()+"元到活期宝" ,1, "温馨提示",function(){

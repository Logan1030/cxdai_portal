...
<html>
<head>
  <title>风险备用金-国诚金融官网</title>
	<meta name="keywords" content="风险备用金" />
	<meta name="description" content="国诚金融P2P网络借贷平台设立风险备用金，风险备用金将由招商银行开设独立托管账户，进行专户管理，用于对逾期借款进行回购。为投资者搭建一个轻松、安全、透明的网络理财平台，详情请登陆www.gcjr.com。">

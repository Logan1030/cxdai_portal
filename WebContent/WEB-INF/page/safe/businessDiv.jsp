<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	${param.isHome!=null?'<h2><a href="#">业务模式</a></h2>':'<h1><a href="#">业务模式</a></h1>' }
         ...
         <div class="help-content" id="list1" style="display: none;">
            <p>国诚金融为专业P2P信息中介平台，为资金需求方和资金借出方提供撮合交易服务。国诚金融官网上所发布的借款信息<%-- （净值标除外） --%>均由国阳资产、新盛典当行等合作机构提供，同时合作机构在国诚金融发布借款信息时，还需提供一定数额的“履约保证金”。</p>
         ...
         <div class="help-content" id="list2">
            <p> 是指国诚金融合作机构，如国阳资产、新盛典当行等，在提供借款信息的同时，为保障出借人的财产安全而充值一定金额到平台，作为借款者到期还款的履约保证，该资金可用于投标但不可提现。</p>
         ...
         <div class="help-content" id="list3">
            <p>借款标出现逾期后，由国诚金融启动“本金保障计划”用“风险备用金账户”进行债权回购，保障借出人的资金安全。同时国诚金融会要求合作机构进行债权回购，如合作机构不履约则由国诚金融扣除其在平台的“履约保证金”，根据双方签署的协议，通过法律手段追究合作机构的责任。</p>

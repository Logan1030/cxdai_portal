      ...
      <div class="tbbox model-box">
            <div class="tbhead tbblue">
                 <div class="tbhead_h2">机构担保标</div>
                      <div class="tbcontent">机构担保标是指国诚金融的合作机构为相应的借款承担连带保证责任的借款标的。<br/><br/></div>
        ...
        <div class="tbbox model-box">
           <div class="tbhead tbgreen">
                 <div class="tbhead_h2">信用认证标</div>
                      <div class="tbcontent">信用认证标是国诚金融对借款用户的个人信用资质进行全面审核通过后，授予其一定额度而允许用户在线发布的借款标的。</div>
       ...
       <%-- <div class="tbbox model-box">
            <div class="tbhead tbyellow">
                 <div class="tbhead_h2">净值标</div>
                      <div class="tbcontent">净值标是指国诚金融的出借者以其在国诚投资的待收作为担保的借款标的。<br/><br/></div>

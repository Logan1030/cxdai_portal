 ...
 */
 function searchFirstInvestBorrowList(searchType){
		...
		$.post("${basePath}/newcxdai/zhitongche//searchFirstInvestBorrowList.html?searchType="+searchType+"&pageNum="+pageNum+"&pageSize="+1, {
		}, function(data) {
...
function goToInvest(borrowId){
	/* $.post("${basePath}/member/isPayPasswordExist.html", {
		...
		if(data == 'notlogin'){
			...
			window.location.href = "${path }/newcxdai/investment/invest/toInvest.html?id="+borrowId;
		}
	}); */

...
<html>
<head>
<title>P2P小额贷款_个人融资_我要融资-国诚金融官网</title>
<meta name="keywords" content="个人融资, P2P小额贷款,我要融资" />
<meta name="description" content="国诚金融是中国3A信用评级互联网理财借贷平台，如果个人或中小企业需要融资，可登陆国诚金融官网了解详情www.gcjr.com。">
		...
		<div class="tbmain">
			<div class="rzbox model-box">
				<div class="rzhead tbgreen">
					...
					<div class="rzcontent">
						<p>诚薪贷是国诚金融为工薪阶层个人量身打造的一款借款产品。满足您个人消费需求，提高生活品质。</p>
						<p>
							<span class="green">申请条件：</span>通过国诚金融个人信用审评
						</p>
					</div>
			...
			<div class="rzbox model-box">
				<div class="rzhead tbblue">
					...
					<div class="rzcontent">
						<p>诚商贷是国诚金融为企业量身打造的一款借款产品。满足您企业的发展需求。</p>
						<p>
							<span class="green">申请条件：</span>通过国诚金融企业信用审评
						</p>
						<br />
					</div>
					<br />
			...
			<div class="rzbox model-box">
				<div class="rzhead">
					...
					<div class="rzcontent">
						<p>净值贷是国诚金融为出借者资金周转方便而打造的一款特殊的借款产品。以出借者在国诚金融的投资待收为担保，满足出借者个人的资金需求。</p>
						<p>
							<span class="green">申请条件：</span>2015年3月1日之前注册成为国诚金融的出借者
						</p>
					</div>

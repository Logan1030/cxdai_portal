...
<body>
		<table width="100%" border="0" style="vertical-align:middle; text-align:center;" cellspacing="0" cellpadding="0"  class="table center">
                  <tr class="tbl-title">
                    <td class="tdpdtitle30" width="25%">借款标题</td>
                    <td class="textr"  width="12%" >借款金额</td>
                    <td class="textr"  width="9%">年利率</td>

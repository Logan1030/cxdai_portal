...
<html>
<head>
 <title>净值贷_国诚金融净值贷-国诚金融官网</title>
	<meta name="keywords" content="净值贷" />
	<meta name="description" content="国诚金融净值贷是为出借用户资金周转方便而打造的一款特殊的借款产品,如果你想了解净值贷或者想了解更多理财产品信息，详情请登陆www.gcjr.com。">
...
<body>
   ...
   <div class="content1" style="display: block;">     
                                         <div class="help-content help-inline">
                                           ...
                                           <td>产品介绍</td>    
                                           <td><p>净值贷是国诚金融为出借用户资金周转方便而打造的一款特殊的借款产品</td>
                                           </tr>
                                          <tr style="background:#fafbfc">
                                           <td>申请条件</td>
                                           <td><p>2015年3月1日之前注册成为国诚金融的出借用户</p></td>
                                           </tr>
                                           <tr style="background:#e1e4e9">
                                           <td>借款年利率</td>
                                           <td><p>6%-24%</p>

<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 ${param.isHome!=null?'<h2><a href="#">债权转让</a></h2>':'<h1><a href="#">债权转让</a></h1>' }
         ...
         <div class="help-content" id="managemoney47">
             <p>指债权持有人通过国诚金融债权转让平台将债权挂出，将所持有的债权转让给购买人的操作。</p> 
         ...
         <div class="help-content" id="managemoney52">
             <p>债权转让的费用为转让管理费。平台向转出人收取，不向购买人收取任何费用。
转让管理费金额为剩余未还本金*转让管理费率，转让管理费率在目前的运营中按0.3%收取，具体金额以债权转让页面显示为准。债权转让管理费在成交后直接从成交金额中扣除，不成交平台不向用户收取转让管理费。

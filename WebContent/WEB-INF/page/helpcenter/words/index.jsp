...
<div class="content" style="display: block;">     
         ...
         <div class="help-content" id="list6">
             <p>国诚金融将按照借款人的借款期限，每月向借款人收取其借款本金的一定比例作为借款管理费。</p> 
         ...
         <div class="help-content" id="list7">
             <p>借款利率是指借款申请人为了获得借款而愿意支付给出借人的年化利率。请注意，在目前的等额本息、每月还款的还款方式下，用户实际支付的年利息低于借款本金x年化利率。</p> 
         ...
         <div class="help-title" onclick="list(9)"><a href="javascript:void(0);" id="help_title">年化利率<span></span></a></div>
         <div class="help-content" id="list9">
             <p>年化利率是把真实利率换算成以年为单位的利率。</p> 
             <p class="up" onclick="list(9)"><a href="javascript:void(0);" id="help_title">&nbsp;</a></p>
         </div>
         <div class="help-title" onclick="list(10)"><a href="javascript:void(0);" id="help_title">年化收益率<span></span></a></div>
         ...
         <div class="help-content" id="list12">
             <p>申请借款的用户需要根据不同的产品提交相应的信用认证材料，经过国诚金融审核后获取相应的信用等级及借款额度。所需提供的认证资料分为必要认证资料和可选认证资料。相关阅读： <a href="${path}/bangzhu/14.html" class="blue">必要认证资料和可选认证资料有哪些？</a>   </p>             <p class="up" onclick="list(12)"><a href="javascript:void(0);" id="help_title">&nbsp;</a></p>
         </div>        
         <div class="help-title" onclick="list(13)"><a href="javascript:void(0);" id="help_title">信用报告</a></div>
         <div class="help-content" id="list13">
             <p>个人信用报告是由中国人民银行出具，全面记录个人信用活动，反映个人信用基本状况的文件。本报告是国诚金融了解用户信用状况的一个重要参考资料。</p> 
         ...
         <div class="help-content" id="list18">
             <p>是指以投资国诚金融平台现有信贷产品（机构担保标、资产抵押标等）为基础的稳健、安全、便捷性好，透明度高的投标计划。加入投标直通车的资金将优先于平台普通用户的资金，根据计划设定的分散投资原则对国诚金融平台产品进行优先投资。<br />
             </p> 
         ...
         <div class="help-content" id="list1" style="display: none;">
            <p>逾期的债权根据国诚金融本金保障计划，由国诚金融“风险备用金”先行回购未到期的本金和利息，回购完成后债权转移至国诚金融名下。</p>

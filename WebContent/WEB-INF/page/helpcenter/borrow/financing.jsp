				...
				<div class="form-info">
					<div class="form-col">
						<label for="" class="colleft form-lable">融资金额<i>*</i></label> <input
							type="text" id="financeMoney" maxlength="5" dataType="Require|Money" name="account"  class="colright form-inpyt-big"  msg="请输入融资金额|输入融资金额范围在1-100000"  placeholder="输入金额">
					         <div style="line-height:45px; float:left; padding-left:10px;">万元</div>
					</div>
					<div class="form-col">
						<label for="" class="colleft form-lable">融资期限<i>*</i></label> <input
							type="text" id="apr" maxlength="2" name="timeLimit" dataType="Require|Number"   class=" colright form-inpyt-big" msg="请输入融资期限|融资期限只能输入数字" placeholder="输入期限">
							<div style="line-height:45px; float:left; padding-left:10px;">月</div>
					</div>
					<div class="form-col">
						<label for="" class="colleft form-lable">联系人<i>*</i></label> <input
							type="text" class="colright form-inpyt-big" id="name" maxlength="15" name="name" dataType="Require" msg="请输入联系人" placeholder="输入联系人姓名">
					</div>
					<div class="form-col">
						<label for="" if="tel" name="tel" class="colleft form-lable">联系电话<i>*</i></label> <input
							type="text" class="colright form-inpyt-big" id="tel" name="tel"  dataType="Require" msg="请输入联系电话 " maxlength="15" placeholder="输入手机号码">
					</div>
					<div class="form-col">
						<label for="" class="colleft form-lable">QQ号</label> <input
							type="text" class="colright form-inpyt-big" name="qq" id="qqNum" require="false" maxlength="15" dataType="Number" msg="请输入合法的QQ号码"  placeholder="输入qq">
					</div>
					<div class="form-col">
						<label for="" class="colleft form-lable" style="padding-top: 2px;">所在地区<i>*</i></label> 
						<div class="rzfrom-r">
						       <p id="residenceProvince"  style="color: #5E5E5E;font-size: 14px;padding-top: 13px ;">上海市</p>
					...
					<div class="form-col">
						<label for="" class="colleft form-lable">验证码<i>*</i></label> <input
							type="text" class="colright form-inpyt-big" id="validatecode" name="validatecode" maxlength="4"
						dataType="Require" msg="请输入验证码" placeholder="输入验证码">
	...
	function FinanceApply() {
		...
		$("#fm").ajaxSubmit({
			...
			success : function(result) {
				loadimage();
				if(result.code=="1"){
					if(layer.msg("您的贷款申请已提交，国诚金融的客服会尽快联系您，请保持您的手机畅通",2,1,function(){
						//启用链接

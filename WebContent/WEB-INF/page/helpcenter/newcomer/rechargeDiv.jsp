<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 ${param.isHome!=null?'<h2><a href="#">充值提现</a></h2>':'<h1><a href="#">充值提现</a></h1>' }  
         ...
         <div class="help-content" id="list12">
             <p>目前平台的充值渠道有：新浪支付、连连支付、网银在线、富友支付。</p> 
         ...
         <div class="help-content" id="list13">
             <p>出借用户通过“网银在线、连连支付、富友支付”在线充值免充值手续费；通过新浪支付充值，第三方支付平台将收取千分之二的充值手续费，最低收取1分。</p> 
         ...
         <div class="help-content" id="list17">
             <p>充值有时会延迟到账，请您耐心等一下！ 您还可以联系<a href="http://www.gcjr.com/onLineServices/webQQ.html"  class="blue" >在线客服</a>或拨打财富热线(400-015-6676)寻求帮助。</p> 
         ...
         <div class="help-content" id="list18">
             <p>周一至周五下午5点前申请提现到账时间为T+1个工作日，周六周日不处理提现。</p> 
         ...
         <div class="help-content" id="list19">
             <p>您可以联系在线客服或拨打财富热线（400-015-6676）进行处理。</p> 

<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 ${param.isHome!=null?'<h2><a href="#">如何投标</a></h2>':'<h1><a href="#">如何投标</a></h1>' }
         ...
         <div class="help-content" id="list30">
             <p>目前平台有资产抵押标、信用认证标、机构担保标等。</p> 
             <p class="up" onclick="list(30)"><a href="javascript:void(0);" id="help_title">&nbsp;</a></p>
         </div>        
         <div class="help-title" onclick="list(31)"><a href="javascript:void(0);" id="help_title">平台官方标的年化利率是多少？<span></span></a></div>
         <div class="help-content" id="list31">
             <p>目前平台官方标的年化利率大于12%。</p> 
             <p class="up" onclick="list(31)"><a href="javascript:void(0);" id="help_title">&nbsp;</a></p>
         </div> 
         <div class="help-title" onclick="list(32)"><a href="javascript:void(0);" id="help_title">国诚金融的投标方式有哪些？ <span></span></a></div>
         <div class="help-content" id="list32">
             <p>目前平台的投标方式有三种：投标直通车投标、自动投标、手动投标。<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;温馨提示：投标直通车投标的范围是平台大于等于20万的抵押标（房产抵押、车辆抵押、民品抵押）、信用标、担保标。</p> 
         ...
         <div class="help-content" id="list33">
             <p>投标直通车是一种投标功能，参加投标直通车的用户，会优先投官方发布的大于等于20万的抵押标（房产抵押、车辆抵押、民品抵押）、信用标、担保标，资金的利用率会更高。</p> 

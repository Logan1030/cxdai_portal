<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 ${param.isHome!=null?'<h2><a href="#">银行卡管理</a></h2>':'<h1><a href="#">银行卡管理</a></h1>' }
         ...
         <div class="help-content" id="list24">
             <p>您可以点击：【账户管理】- <a class="blues-c" href="${path }/bankinfo/toBankCard.html" >【银行卡信息】</a> -点击【更换】，根据系统提示操作；如果账户资金总额低于100元，可以自行操作换卡。</p> 
         ...
         <div class="help-content" id="list25">
             <p>您可以随时将您在国诚金融账户中的可用资金申请提现到您绑定的提现银行卡账户中。 <a href="${path }/myaccount/cashRecord/toCashIndex.html" class="blue" >查看操作流程>></a>   </p>
			 <p>注意：申请提现的银行卡账号，应确保该账号的开户人姓名和您在国诚金融网站上提供的身份证上的真实姓名一致，否则无法成功提现。</p> 
         ...
         <div class="help-content" id="list29">
             ...
             <p>2. 可能银行到账时间有所延迟，请直接联系在线客服，或拨打财富热线（400-015-6676）。</p> 

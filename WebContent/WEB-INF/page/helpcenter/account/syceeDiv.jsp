...
<div class="help-content" id="list1" style="display: none;">
	<p>
		元宝被用来衡量国诚投资用户对平台的贡献，也是平台对用户的回馈奖励。元宝可用来增加用户的荣誉值，也可以在元宝商城兑换各种礼品，如红包、iPhone6等，兑换后扣减相应元宝。<a style="color: #09F;" href="${path}/sycee.html">立即兑换></a>
	</p>
...
<div class="help-content" id="list3">
	<p>荣誉值提现了投资用户对国诚的贡献大小，由历史元宝累加得来，用户获得1元宝同时会获得1荣誉值</p>

...
<body>
   ...
   <div class="content" style="display: block;">     
         ...
         <div class="help-content" id="list1">
             <p>第一届投资者监督委员会成立于2014年3月22日，投资者参选采用自愿报名的方式，在国诚金融论坛发布竞选帖子。主要介绍投资者本人基本情况、对理想网贷平台的要求与展望、对投资者监督委员会成员责任和义务的认识、如果当选应该如何更好开展工作等内容。  </p> 
         ...
         <div class="help-content" id="list2">
              <p>投资人入股需要参照加权待收、论坛累计积分、投标直通车、推荐新人用户数的权重指标取值计算的，具体可参考国城论坛公告国诚金融入股方案修正版<a href="${bbsPath}/posts/66156/1" class="blue" >查看</a> 。</p> 
         ...
         <div class="help-content" id="list3">
             <p>为了更好的透明和规范运作，国诚金融将风险准备金委托招商银行股份有限公司上海分行托管，由招商银行单独开设托管账户，进行专户管理; 您可以到<a href="${path}/gonggao/58.html" class="blue" >“网站公告”</a>里了解一下。</p> 

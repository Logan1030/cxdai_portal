	...
	<ul id="menuul">
		...
		<li id="firstMenu3" onclick="showHideLeftItems(this);" ><a href="${path }/bangzhu/jiekuan.html"><span class="icon icon2"></span>如何借款</a>
			<ul>
				...
				<li id="menu3-2"><a href="${path }/bangzhu/13.html">如何申请</a></li>
				<li id="menu3-3"><a href="${path }/bangzhu/14.html">认证资料</a></li>
				<li id="menu3-4"><a href="${path }/bangzhu/15.html">信用审核</a></li>
				<li id="menu3-5"><a href="${path }/bangzhu/16.html">信用等级与额度</a></li>
				<li id="menu3-6"><a href="${path }/bangzhu/17.html">筹款与提现</a></li>
				<li id="menu3-7"><a href="${path }/bangzhu/18.html">如何还款</a></li>
			</ul>
		</li>
...
// 	setMenuCss(moneyStrAry,1);
    ...
    var zhanghuAry = new Array("bangzhu/19.html","bangzhu/20.html","bangzhu/21.html","bangzhu/26.html");

...
<div id="header">
         <div class="inner">   
                   ...
                   <a class="head-phone-icon" href="http://bbs.gcjr.com/ext/androidapp.html"> 手机版</a>
          ...
          <div class="head-ewm-tag" style="">
            ...
            <img src="${basePath }/images/erweima1.png" alt="国诚金融"/>
            <span>服务号</span>
          </div>
          <div class="head-ewm-img" style=" margin-left:50px;clear: right;">
            <img src="${basePath }/images/erweima.png" alt="国诚金融"/>
            <span>公众号</span>
          </div>
          </div>
			   ...
			   <div class="loginbar" style="width:480px;"> 
                     ...
                     <li id="navDown5"><a href="${path }/zixun.html" class="gls">国诚资讯</a></li>
           ...
           <c:if test="${logotype != null && logotype == '1' }">
	           <h1> 
	           <a href="${path}/"><img alt="囯诚金融" src="${basePath}/images/main/logo.png" width="160" height="72"></a>
	           </h1> 
           </c:if>    
        ...
        <div class="userbar">
            <ul class="nav">
				...
				<li id="navDown3"><a href="${bbsPath}" target="_blank"   class="gls">国诚社区</a>
                </li>
            ...
            <shiro:notAuthenticated>          	
     			<a style="color:#00a7e5" id="toRegisterLink" href="${path }/member/toRegister.html" rel="nofollow">注册</a>
            	<a href="${path}/member/toLogin.html" rel="nofollow">登录</a>
            </shiro:notAuthenticated>
            </div>
        </div>
    </div>

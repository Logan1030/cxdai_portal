	...
	<div class="margin_lists">
		...
		<div class="demo" style="">
			<nav class="main_nav" style="">
				<ul>
					<li><a class="cd-signin" href="javascript:openVideo();" title="1分钟了解国诚"><img src="${path}/images/spsmallicon1.png"/></a></li>
			</ul>
			</nav>
		</div>
...
<a class="safe-link dialog" href="${path }/anquan.html" target="_blank">
   ...
   <div class="safe_txts">出借者在国诚金融的投资<span class="blues">100%</span>适用于本金保障计划，风险备用金托管于光大银行，有效保障投资者的资金安全。</div>
 </a>
 </div>

...
<div id="footer" style="height: auto;">
	...
	<div class="footers" style=" ">
		<span>
			...
			<a href="${bbsPath}" rel="nofollow" target="_blank">官方社区</a>
	...
	<div class="footers" style="width:980px;">
		<div id="friendlinks" style=" width:90%;height:30px;">
			<span>友情链接：</span>
			<a href="http://www.gcjr.com/" target="_blank">国诚金融</a>
			...
			<a href="http://i.youku.com/u/UMTY1OTAwMTIyMA==" rel="nofollow" target="_blank">国诚金融优酷频道</a>
	...
	<dl class="pg-footer-focus">
       ...
       <dd><a class="pg-footer-icon mark" target="_blank" title="在线客服" href="http://www.gcjr.com/onLineServices/webQQ.html"   rel="nofollow"></a></dd>
   	</dl>
	</div>
	...
	<div  style="display: none" id="imgShowId">
			 	<table   >
					<tr><td><img title="国诚金融" id="imgId" src="${basePath }/images/weixin.jpg"></td><td title="国诚金融"><img title="国诚金融" id="imgId" src="${basePath }/images/wxservicenum.jpg"></td></tr>
...
© Copyright 2016 上海国诚金融信息服务有限公司 版权所有 | 
上海市虹口区西江湾路388号凯德龙之梦A座32楼&nbsp;  
电话：021-80100999 | 
沪ICP备13021943号-2
<br/>
<div class="beian-box">
...
<p title="请输入您的联系方式，我们会在稍后联系您为您服务.">
	<span><input type="text" id="feedbackMobileNum" style=" border:1px solid #dbdbdb;margin-top:8px; width:120px;" value="" placeholder="400-015-6676"/></span>&nbsp;&nbsp;
...
<p>
<a href="mailto:marketing@gcjr.com" rel="nofollow">marketing@gcjr.com</a>
</p>
</div>
<div class="sf_qqgroup" style="width: 36px; height: 38px; overflow: hidden;">
<p>
<a href="http://www.gcjr.com/onLineServices/webQQ.html" target="_blank" rel="nofollow">
客服QQ（在线咨询）</a>
</p>
</div>
<div class="sf_weibo" style="overflow: hidden; width: 36px; height: 38px;">
<p>
<a target="_blank" href="http://weibo.com/u/3805446108" rel="nofollow">新浪微博@国诚金融</a>
</p>
</div>

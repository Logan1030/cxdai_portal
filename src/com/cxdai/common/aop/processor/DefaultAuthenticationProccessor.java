...
import com.cxdai.common.aop.annotation.DisableDuplicateSubmission;
import com.cxdai.common.aop.exception.AuthenticationException;
import com.cxdai.common.cache.CacheProxy;
import com.cxdai.common.cache.CacheProxyFactory;
import com.cxdai.utils.AspectUtil;

/**
 * 默认的认证处理方法，主要为了保证第一次请求未完成时不允许第二次请求
 * <p>
 * Description:此方法无法防止二次请求<br />
 * Token认证方式请见 {@link com.cxdai.common.aop.processor.TransientTokenAuthenticationProccessor}
 * </p>

...
public final class BorrowXiyi {
	...
	public static String getBorrowXiyi(HttpServletRequest request, Borrow borrow, List<TenderRecordVo> list, String userName) {
		...
		sb.append("<span style='font-weight:bold;font-size: 12px;line-height:20px;'>乙方（借款人）：国诚金融用户名：<font color='red'>" + userName + "</font><br/>");
		sb.append("丙方（见证人）：上海国诚金融信息服务有限公司（联系地址：上海市虹口区西江湾路388号凯德龙之梦A座32楼）<br/>");
		sb.append("鉴于</span>：<br/>");
		sb.append("1、丙方是一家在上海合法成立并有效存续的有限责任公司，拥有www.gcjr.com 网站（以下简称“该网站”）的经营权，该公司具有提供金融信息服务、数据处理服务及投资咨询服务等；<br/>");
		...
		sb.append("2、任何一方违约，违约方应承担因违约使得其他各方产生的费用和损失，包括但不限于调查、诉讼费、律师费等，应由违约方承担。如违约方为乙方的，甲方有权立即解除本协议，并要求乙方立即偿还未偿还的本金、利息、罚息、违约金。此时，乙方还应向丙方支付所有应付的借款管理费。如本协议提前解除时，乙方在www.gcjr.com网站的账户里有任何余款的，丙方有权按照本协议第四条第3项的清偿顺序将乙方的余款用于清偿，并要求乙方支付因此产生的相关费用。<br/>");
		...
		sb.append("出借人和借款人均同意，如借款人逾期 (抵押标第10天垫付，推荐标第10天垫付，净值标第3天垫付。具体请参考网站最新垫付规则：https://www.gcjr.com/safe/index.html)在网站垫付前仍未清偿借款本息,则出借人将本协议项下的债权转让给本网站合作商；转让价格为不超过借款人逾期仍未偿还的借款本息（具体金额视出借人在本网站的会员级别不同而有所不同），本网站合作商向出借人支付借款人逾期仍未偿还的本金即可取得出借人在本协议项下的债权；本网站合作商将依法自行承担清收费用，向借款人追收借款本金、利息、逾期罚息等，坏账风险由本网站合作商承担。但是，本网站合作商作为独立的营利性组织机构在查实借入者和出借者合伙诈骗的情况下可拒绝受让出借人在本协议项下的债权，本网站将不遗余力追究相关人员的法律责任。<br/>");
		...
		if (request != null) {
			...
			sb.append("<div align='right'><img src='https://www.gcjr.com/images/CompanyElectronicChapter.gif'/></div>");
		}
		sb.append("</div>");
		return sb.toString();
	}
	...
	public static String getBorrowXiyiForTJ(HttpServletRequest request, Borrow borrow, List<TenderRecordVo> list, String userName) {
		...
		// sb.append("罚息总额 =( 逾期本息总额+逾期借款管理费)×罚息利率0.2%×逾期天数；<br/>");
		sb.append("  如借款人逾期，丙方当天晚上22点垫付当月的本息，剩余月份只垫付本金。（具体请参考网站最新垫付规则：https://www.gcjr.com/safe/index.html)在网站垫付前仍未清偿借款本息,则出借人将本协议项下的债权转让给本网站合作商；转让价格为不超过借款人逾期仍未偿还的借款本息（具体金额视出借人在本网站的会员级别不同而有所不同），本网站合作商向出借人支付借款人逾期仍未偿还的本金即可取得出借人在本协议项下的债权；本网站合作商将依法自行承担清收费用，向借款人追收借款本金、利息、逾期罚息等，坏账风险由本网站合作商承担。但是，本网站合作商作为独立的营利性组织机构在查实借入者和出借者合伙诈骗的情况下可拒绝受让出借人在本协议项下的债权，本网站将不遗余力追究相关人员的法律责任。<br/>");

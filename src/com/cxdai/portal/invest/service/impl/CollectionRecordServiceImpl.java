...
import com.cxdai.portal.invest.mapper.AccCommonCollectionMapper;
import com.cxdai.portal.invest.mapper.CollectionStatisticMapper;
 ...
 * @author hujianpan
 * @package 
 *          com.cxdai.portal.invest.service.impl.CollectionRecordServiceImpl.java
 * 
 */
@Service
public class CollectionRecordServiceImpl implements CollectionRecordService {
	...
	private void convertParameter(Map<String, Object> parameter) {
		...
		if (beginTime != null && !"".equals(beginTime)) {
			beginTime = com.cxdai.utils.DateUtils.date2TimeStamp(beginTime);
			parameter.put("beginTime", beginTime);
		}
		if (endTime != null && !"".equals(endTime)) {
			endTime = com.cxdai.utils.DateUtils.dayOffset(DateUtils.parse(endTime, DateUtils.YMD_DASH), 1).getTime() / 1000L + "";

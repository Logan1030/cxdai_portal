...
import com.cxdai.portal.lottery.controller.LotteryUseRecordController;
import com.cxdai.portal.lottery.mapper.LotteryGoodsSendInfoMapper;
...
public class LotteryUseRecordServiceImpl implements LotteryUseRecordService {
	 ...
	 *  (non-Javadoc)
	 * @see com.cxdai.portal.lottery.service.LotteryUseRecordService#upStatusRemarkByQrsh(com.cxdai.portal.lottery.vo.LotteryUseRecordCnd)
	 */
	@Override
	@Transactional(rollbackFor = Exception.class, propagation = Propagation.REQUIRES_NEW)

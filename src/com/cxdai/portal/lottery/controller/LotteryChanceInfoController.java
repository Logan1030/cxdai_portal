...
public class LotteryChanceInfoController extends BaseController {
	...
	public ModelAndView toRecommendaward(HttpSession session, HttpServletRequest request) {
		...
		if (shiroUser == null) {
			...
			// 查询推荐链接
			String recommendPath = "/member/toRegister.html?code=" + shiroUser.getUserIdMD5();
...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			String content = "http://www.gcjr.com/member/toRegister.html?code=DB09D320F63119E7558A48D1B4FF55AE";
			byte[] contentBytes = content.getBytes("UTF-8");

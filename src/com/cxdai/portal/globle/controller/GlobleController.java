package com.cxdai.portal.globle.controller;
...
public class GlobleController extends BaseController {
	...
	@RequestMapping(value = "/jianjie/data")
	public ModelAndView data() {
		return forword("index/operateData");
	}

	@RequestMapping(value = "/jianjie/supervise")
	public ModelAndView supervise() {
		return forword("index/investSupervise");
	}

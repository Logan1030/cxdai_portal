package com.cxdai.portal.outerInterface.service.impl;
...
import com.cxdai.portal.outerInterface.entity.ExternalAccessLog;
import com.cxdai.portal.outerInterface.mapper.OuterInterfaceMapper;
import com.cxdai.portal.outerInterface.service.HSWInterfaceService;
import com.cxdai.portal.outerInterface.vo.ExternalAccessLogCnd;
import com.cxdai.portal.outerInterface.vo.OuterParamCnd;
import com.cxdai.portal.outerInterface.vo.OverdueBorrowVo;
import com.cxdai.portal.repayment.vo.BRepaymentRecordVo;
import com.cxdai.utils.DateUtils;
import com.cxdai.utils.JsonUtils;
			...
			if (judgeIPByAccessByDate(ip, Constants.HSW_BORROW_INFO, 60, now) == 0) {
				...
				try {
					...
					for (int i = 0; i < list.size(); i++) {
						...
						borrow_map.put("link", "https://www.gcjr.com/toubiao/" + borrow.getId() + ".html"); // 当前页数
			...
			if (judgeIPByAccessByDate(ip, Constants.HSW_TENDERRECORD_INFO, 60, now) == 0) {
				...
				try {
					...
					for (int i = 0; i < list.size(); i++) {
						...
						tender_record_map.put("link", "https://www.gcjr.com/toubiao/" + tenderRecord.getBorrowId() + ".html"); // 当前页数

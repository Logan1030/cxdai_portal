		...
		if (list.size() > 0) {
			for (BorrowVo borrow : list) {
				...
				if (borrow.getHeadimg() != null && borrow.getHeadimg().equals("")) {
					borrow_map.put("UserAvatarUr", "https://www.gcjr.com" + borrow.getHeadimg()); // 发标人头像
				} else {

...
public interface BusinessConstants {
	...
	public static String ONLINE_PAY_LLWAP_FRONTURL_PREFIX_M = new String("http://m.gcjr.com"); // 支付成功跳转的页面m域名
	public static String ONLINE_PAY_LLWAP_FRONTURL_PREFIX_ANDROID = new String("http://android.gcjr.com"); // 支付成功跳转的页面android域名
	...
	// 网银在线自动调用本系统接口URL地址进行对账,上线需要改成https,对应192.168.1.42/cxdai_portal
	// public static String CHINABANK_AUTO_RECEVIE_URL =
	// "http://140.207.113.250:8088/cxdai_portal/account/topup/chinabank/autoRecevie.html";
	public static String CHINABANK_AUTO_RECEVIE_URL = new String("http://www.gcjr.com/autoreceive/chinabank.html");
	// 网银在线充值成功之后,系统显示的返回商户链接地址
	public static String CHINABANK_RECEVIE_URL = new String("http://www.gcjr.com/account/topup/chinabank/recevie.html");
	// public static String CHINABANK_RECEVIE_URL =
	// "http://140.207.113.250:8088/cxdai_portal/account/topup/chinabank/recevie.html";
	 ...
	 * 禁止发净值标, 8：直通车下车，9：禁止微信消息群推，10：禁止加入活期宝,11:禁止加入定期宝】 BEGIN
	 */
	...
	public static final Integer BLACK_TYPE_TENDER_FIX_BORROW = 11;
	/**
	 * 黑名单禁止操作类型【1：禁止手动投标，2：禁止认购直通车，3：禁止认购债权转让，4：禁止设置自动投标，5：禁止线上充值，6：禁止提现，7：

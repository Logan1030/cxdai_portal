...
public class SendEmailTemplate {
	...
	public static String packageVerifyContent(HttpServletRequest request,
		...
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎您加入国诚金融大家庭，我们将<font color='red'>用心呵护您的财富，和您一起分享成长的快乐！</font><br/>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您在国诚金融平台上的用户名是：<font color='red'>"
				+ memberVo.getUsername() + "</font><br/>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请点击下面链接，完成您的邮箱验证：<br/>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='"
				+ linkage + "'>" + linkage + "</a><br/>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果链接无法点击，请将链接复制到浏览器地址栏中进行访问。<br/>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此信是由国诚金融系统发出，系统不接受回信，请勿直接回复。如有任何疑问，请联系我们：400-015-6676，我们将竭诚为您服务！");
		return sb.toString();
	}
	/**
	 * <p>
	...
	public static String findPwdContent(String username, String type, String randCode) {
		StringBuilder sb = new StringBuilder();
		sb.append("<font color='red'>您好：</font><br/>");
		sb.append("<div style='margin-left:20px;'>欢迎您加入国诚金融大家庭，我们将<font color='red'>用心呵护您的财富，和您一起分享成长的快乐！</font></div>");
		sb.append("<div style='margin-left:20px;'>您在国诚金融平台上的用户名是：<font color='red'>"
				+ username + "</font></div>");
		...
		sb.append("<div style='margin-left:20px;'>本次密码为临时密码，请您尽快登录系统修改<font color='red'>"
				+ type + "密码</font></div>");
		sb.append("<div style='margin-left:20px;'>此信是由国诚金融发出，系统不接受回信，请勿直接回复。如有任何疑问，请联系我们：400-015-6676，我们将竭诚为您服务！</div>");
		return sb.toString();
	}
}

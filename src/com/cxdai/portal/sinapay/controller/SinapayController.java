package com.cxdai.portal.sinapay.controller;
...
import com.cxdai.portal.sinapay.protocol.SinaPayLoserSupport;
import com.cxdai.portal.sinapay.service.SinapayService;
import com.cxdai.portal.sinapay.tool.CallServiceUtil;
import com.cxdai.portal.sinapay.tool.Tools;
 ...
 * @package com.cxdaiweb.account.account.controller
 * @author gang.li
...
public class SinapayController extends BaseController {
	...
	public String loseSend(String v_oid, String startTime, String endTime, HttpServletRequest request) {
		...
		try {
			...
			Map<String, String> queryContent = (Map<String, String>) com.cxdai.portal.util.JsonUtils.json2Map(queryResult);
			String signKey = "";

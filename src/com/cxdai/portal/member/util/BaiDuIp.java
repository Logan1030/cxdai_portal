...
public class BaiDuIp {
	...
	public static void main(String[] args) {
		System.out.println(queryAddrByIp_bak("116.236.196.146").getCity());
	}
	/**
	 * <p>
	...
	public static final IpAddr queryAddrByIp_bak(String ip) {
		String url = new StringBuffer(112)
					.append("http://apis.baidu.com/apistore/iplookupservice/iplookup")
					.append("?apikey=4a57f0d72b8d7c9a3673f72e43d8b856")
					.append("&ip="+ip)
					.toString();
		try {

...
public class SendSmsTest {
	...
	public void testSendSms() throws UnsupportedEncodingException, Exception {
		...
		for (int i = 0; i < result; i++) {
			...
			// 调用发送短信接口
			// String content =
			// "尊敬的国诚金融用户，由于3月30日中午国诚金融网站遭受攻击，导致官网无法访问，目前技术部门正在积极修复，在此向您表示由衷的歉意。 今天21:00前的提现申请我们会在当天进行处理打款，给您带来的不便敬请谅解！如有疑问请联系在线客服或拨打（400-015-6676）进行咨询，退订回复td【国诚金融】";
			// 发送短信
	...
	public static void main(String[] args) throws UnsupportedEncodingException, Exception {
		// String content =
		// "尊敬的国诚金融用户，由于公司将上线移动端充值功能以及采用第三方支付打款给提现的用户。不在支持列表里的银行卡将不能提现。请您重新绑定您在国诚金融的银行卡或者联系客服400-015-6676。给您带来不便敬请谅解！谢谢！国诚金融运营部。【国诚金融】";
		// ZucpSmsUtil.sendSms(URLEncoder.encode(content, "UTF-8"),
